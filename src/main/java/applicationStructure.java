...
4. Реализовать фукционал создания, удаления и оправка файлов на удаленный сервер Nginx.
    ...
    class Client{
        ...
        /*
            1. Создать функционал для установления соединения с сервером:
               ...
               * Создать функцию ReceiveMessage(), для получения на клиенте текстового сообщения,
              ...
              * Создать метод createAnFiles(), для создания видео файлов,
               ...
               * Создать метод отправки видео файлов, для этого неоходимо следующее:
                 ...
                 * Создать массив типа byte, для добавления заголовка, о количестве отправляемых байтов и
                   сереализованного оправляемого объекта.
