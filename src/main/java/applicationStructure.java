...
class applicationStructure {
    ...
    class Client{
        ...
        /*
            1. Создать функционал для установления соединения с сервером:
               * Создать функцию Connect() подключение клиента с удаленным сервером.
            2. Принимать входящий запрос с удаленного сервера с помощью протокола TCP/IP транспортного уровня,
                на изменение или устанавления нового значения.
               ...
               * Создать обобщенный объект типа ReadWriteStreamAndReturnGenericObject, с двумя методоми
                 modelDeserialization() и modelSerializable(), с возвращаемым обобщенным типом T и void соответственно.
               * Создать интерфейс SendDataParameter, для горизонтального масштабирования,
                 в методе modelDeserialization десереализованного объекта, т.е. добавить слабасвязанность и универсальность.
        ...
        /*
            4. Реализовать фукционал создания, удаления и отправки файлов на удаленный сервер Nginx.
              * Создать метод createAnFiles(), для создания видео файлов,
               ...
               *  Создать функцию удаление файлов основываясь на методанных из файла dash.mpd,
                    после успешной записи на удаленный сервер.
